package com.nebo.homework.tvplay;
...
import com.nebo.hadoop.mapmultiinputformat.ScoreCount;
import com.nebo.hadoop.mapmultiinputformat.ScoreInputFormat;
import com.nebo.hadoop.mapmultiinputformat.ScoreWritable;
import com.nebo.hadoop.mapmultiinputformat.ScoreCount.ScoreMapper;
import com.nebo.hadoop.mapmultiinputformat.ScoreCount.ScoreReducer;
...
public class TVCount extends Configured implements Tool {
	...
	public static class TVMapper extends Mapper<Text, TVWritable, Text, TVWritable>{
		...
		@Override
		protected void map(Text key, TVWritable value, Mapper<Text, TVWritable, Text, TVWritable>.Context context)
