...
public class NaviteIO {
    public static class POSIX {
        ...
        private static final Log LOG = LogFactory.getLog(NaviteIO.class);
        ...
        public static class CacheManipulator {
            ...
            public long getMemlockLimit() {
                return NaviteIO.getMemlockLimit();
            }

            public long getOperatingSystemPageSize() {
                return NaviteIO.getOperatingSystemPageSize();
            }
