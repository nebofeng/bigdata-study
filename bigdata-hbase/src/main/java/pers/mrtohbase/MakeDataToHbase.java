 ...
 * @ des :
 */
public class MakeDataToHbase {
    // 表名
    private static String TN = "eventlog";

    private  static String dateString="20191222";

    public static void main(String[] args) throws Exception {

        MakeDataToHbase tDataMaker = new MakeDataToHbase();
        ...
        Table table = conn.getTable(TableName.valueOf(TN));
        ...
        for (int i = 0; i < 100; i++) {
            ...
            Date d = tDataMaker.getDate(dateString);
    ...
    public Put putMaker(String uuid, String memberId, String serverTime) {
        ...
        clientInfo.put(EventLogConstants.LOG_COLUMN_NAME_COUNTRY, "demo1");
        clientInfo.put(EventLogConstants.LOG_COLUMN_NAME_PROVINCE, "demo2");
        clientInfo.put(EventLogConstants.LOG_COLUMN_NAME_CITY, "demo3");
